...
<div class="app-shell<?= $logged ? ' app-shell--nav-drawer' : '' ?>" id="appShell">
    ...
    <aside class="sidebar" id="sidebar" aria-hidden="true">
        <div class="brand">
            <img src="<?= htmlspecialchars(Router::url('/assets/img/logo.jpeg'), ENT_QUOTES, 'UTF-8') ?>" alt="<?= Lang::e('app.name') ?>" class="brand-logo" width="44" height="44">
            <div>
    ...
    <div class="main-wrap <?= $logged ? '' : 'main-wrap-full' ?>">
        ...
        <header class="topbar">
            ...
            <div class="topbar-brand">
                <img src="<?= htmlspecialchars(Router::url('/assets/img/logo.jpeg'), ENT_QUOTES, 'UTF-8') ?>" alt="" class="topbar-brand-logo" width="32" height="32">
