...
<div class="card calendar-toolbar">
    <div class="tabs" id="calTabs" role="tablist" aria-label="<?= Lang::e('nav.calendar') ?>">
        <button type="button" class="tab active" role="tab" aria-selected="true" data-view="month" id="cal-tab-month"><?= Lang::e('calendar.view_month') ?></button>
        <button type="button" class="tab" role="tab" aria-selected="false" data-view="week" id="cal-tab-week"><?= Lang::e('calendar.view_week') ?></button>
        <button type="button" class="tab" role="tab" aria-selected="false" data-view="day" id="cal-tab-day"><?= Lang::e('calendar.view_day') ?></button>
        <button type="button" class="tab" role="tab" aria-selected="false" data-view="vehicle" id="cal-tab-vehicle"><?= Lang::e('calendar.view_vehicle') ?></button>
    </div>
...
<script>window.__calLocale=<?= json_encode(str_replace('_', '-', Lang::locale()), JSON_THROW_ON_ERROR) ?>;window.__calError=<?= json_encode(Lang::get('calendar.load_error'), JSON_THROW_ON_ERROR) ?>;window.__calRetry=<?= json_encode(Lang::get('calendar.retry'), JSON_THROW_ON_ERROR) ?>;</script>
