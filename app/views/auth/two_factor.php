...
<form method="post" action="<?= Router::url('/login/2fa') ?>" class="form-stack auth-form">
    ...
    <div class="auth-field">
        ...
        <div class="auth-input-wrap">
            ...
            <input class="input auth-input-field mono auth-otp-input" id="code" name="code" inputmode="numeric" pattern="[0-9]{6}" maxlength="6" autocomplete="one-time-code" autofocus placeholder="000000">
        </div>
    </div>
    <div class="auth-field">
        <label class="auth-label" for="recovery_code"><?= Lang::e('auth.recovery_code') ?></label>
        <input class="input auth-input-field mono" id="recovery_code" name="recovery_code" autocomplete="off" placeholder="XXXX-XXXX">
        <p class="help-text muted"><?= Lang::e('auth.recovery_hint') ?></p>
    </div>
