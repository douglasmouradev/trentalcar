...
final class AccountController
{
    ...
    public function enableTotp(): void
    {
        ...
        header('Location: ' . Router::url('/account/security/recovery'));
        exit;
    }
    ...
    public function disableTotp(): void
    {
        ...
        TotpRecovery::clear($uid);
        unset($_SESSION['totp_setup_secret'], $_SESSION['totp_recovery_codes']);
    ...
    public function recoveryCodes(): void
    {
        ...
        $codes = $_SESSION['totp_recovery_codes'] ?? null;
        if (!is_array($codes) || $codes === []) {
            header('Location: ' . Router::url('/account/security'));
            exit;
        }
        unset($_SESSION['totp_recovery_codes']);
        View::render('account/recovery_codes', [
            'title' => Lang::get('account.recovery_title'),
            'codes' => $codes,
            'remaining' => TotpRecovery::remainingCount($uid),
        ], 'main');
    }
}
